addpath('M:\Project Demo\CGP_Trial');
...
clf;
ClassColor = 'DarkRed';
bar(chromoOutputs,'FaceColor',rgb('SteelBlue'));
line([1 30],[100 100],'LineWidth',3, 'Color', rgb('IndianRed'));
line([1 30],[200 200],'LineWidth',3, 'Color', rgb('SaddleBrown'));
line([5 5],[min(chromoOutputs)-20 max(chromoOutputs)],'LineWidth',3,'Color',rgb(ClassColor));
line([15 15],[min(chromoOutputs)-20 max(chromoOutputs)],'LineWidth',3,'Color',rgb(ClassColor));
line([25 25],[min(chromoOutputs)-20 max(chromoOutputs)],'LineWidth',3,'Color',rgb(ClassColor));
xlim([0 30]);
ylim([min(chromoOutputs)-20 max(chromoOutputs)+100]);
